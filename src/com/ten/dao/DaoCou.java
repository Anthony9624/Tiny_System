...
public class DaoCou {
	...
	public static final String sql_selectone = "select * from course where CNo=?";//查询某一条报名信息
	public static final String sql_update = "update course set Cname=?,Ccredit=? where CNo=?;";//修改一条报名信息
	public static final String sql_delete = "delete from course where Cno=?;";//删除一条报名信息
	public static final String sql_insert = "insert into course(Cname,Ccredit) values(?,?);";//添加一条报名信息
