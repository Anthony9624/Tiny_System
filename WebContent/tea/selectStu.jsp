		...
		<div class="box">
			...
			<div class="form">
				<table>
  					<tr><td></td></tr>
  					<tr>
  						<td>学生编号</td><td>学生姓名</td><td>报名课目</td><td>所在班级</td><td>学生性别</td><td>学分数</td>
  						<td><input class="btn" type="button" value="添加报名信息" onclick="window.location.href=('/Ten/tea/InsertStu.jsp')"/></td>
  					...
  					<td><input class="btn" type="button" value="修改报名信息" onClick="window.location.href=('/Ten/tea/updateStu.jsp?id=<%= stu.getSNo() %>')"></td>
  					<td><input class="btn" type="button" value="删除报名信息" onClick="window.location.href=('/Ten/servlet/serDeleteStu?id=<%= stu.getSNo() %>')"></td>
  					</tr>
  					<%} %>
  				</table>
  			<div class="form_1">
				...
				<tr><td><input  class="btn" type="submit" value="确认发布"/></td></tr>
				</table>
				</form>
