...
<div class="main">
	...
	<div class="main_right">
		...
		<div class="box">
			<div class="function"><p>[通知]网上报名系统已开放</p></div>
			<div class="form">
			<div class="form_1">
				...
				<table>
  					...
  					<tr><td>学生报考院校</td> <td><input  class="text" type="text" name="Sclass"/></td></tr>
  					<tr><td>学生报考科目</td> <td><input  class="text" type="text" name="Ssex"/></td></tr>
  					<tr><td></td><td><input class="btn" type="submit" value="发布"/>  </td></tr>
