			...
			<div class="form">
				<table>
  					...
  					<tr>
  						...
  						<td><input class="btn" type="button" value="添加考试信息" onclick="window.location.href=('/Ten/tea/InsertCou.jsp')"/></td>
  					...
  					<td><input  class="btn" type="button" value="修改发布信息" onClick="window.location.href=('/Ten/tea/updateCou.jsp?id=<%= cou.getCNo() %>')"></td>
  					<td><input  class="btn" type="button" value="删除发布消息" onClick="window.location.href=('/Ten/servlet/serDeleteCou?id=<%= cou.getCNo() %>')"></td>
  					</tr>
		  				<%
		   			}
		   		}
