...
<div class="main">
	<div class="main_left">
		...
		<div class="main_left_class01"><a href="stu/baoming.jsp">考试报名</a></div>
		<div class="main_left_class02"><a href="stu/showCou.jsp">报名查询</a></div>
	...
	<div class="main_right">
		...
		<div class="box">
			...
			<tr><td>一、报名时间：6月16日----6月20日</td></tr>
			<tr><td>二、学生登录学生网上报名系统后进入考试报名页面进行考试报名。学生报名前请认真阅读选课公告，再进行“学生网上报名系统”。</td></tr>
			<tr><td>三、管理员可登陆学生网上报名系统后进入选课管理增删报名， 6月15日14:00之后各位教师及学生登录教务处网站查询自己申报的报名课程是否停开。</td> </tr>
			<tr><td>四、学生网上报名系统均须在规定时间内完成，报名结束后不再进行补退选，请学生注意选课时间。</td></tr>
			<tr><td>五、请各学院通知并组织学生进行网上报名，同时请各学院及相关单位通知任课教师自行通知。教务处将组织相关人员对报名情况进行不定期的检查。</td></tr>
