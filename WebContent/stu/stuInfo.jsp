...
<html>
  <head>
    ...
    <meta charset="UTF-8">
	<title>学生报名信息管理系统-显示学生报名后所有信息信息</title>
  ...
  <body>
<div class="top">
	<div class="title"><p> 学生网上报名管理系统 </p></div>
</div>
<div class="main">
	<div class="main_left">
		<div class="main_left_class00"><img src=img/touxiang.png></div>
		<div class="main_left_class01"><a href="stu/baoming.jsp">学生报名</a></div>
			...
			<div class="form_1">
				...
				<%
  					...
  					<tr><td></td><td><input class="text" type="text" value="学号：<%= stu.getSNo() %>" readonly="true"></input></td></tr>
  						...
  						<tr><td></td><td><input class="text" type="text" value="报考科目：<%= select1.selectScre(stu).getScredit() %>" readonly="true"></td>
  					</tr>
